...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
   FinalTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier forIndexPath:indexPath];
    
    // Configure the cell...
    ImageWithTitle* imageView=[_content objectAtIndex:indexPath.row];
    cell.image.image=imageView.image.image;
    cell.name.text=imageView.name;
